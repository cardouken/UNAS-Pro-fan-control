...
DEFAULT_MIN_TEMP=43       # Temperature (°C) where fans start ramping up from baseline
DEFAULT_MAX_TEMP=47       # Temperature (°C) where fans reach maximum speed
DEFAULT_MIN_FAN=204       # Baseline PWM (204 = 80%)
